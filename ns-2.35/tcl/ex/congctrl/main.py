...
parser.add_option("--result", type="string",dest="result_name",default="result-throughput-delay")
parser.add_option("--topo", type="string", dest="topo",default="Dumbbell")
parser.add_option("-w","--whiskers",  type="string",dest="whiskers", default="./whiskers/whiskers-throughput-delay")
